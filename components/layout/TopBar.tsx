      ...
      <Container className="flex items-center gap-7 py-4">
        ...
        <div className="flex items-center gap-1.5 ml-auto">
          ...
          >
            ...
            {cartCount > 0 && (
              <span className="absolute -top-0.5 -right-0.5 min-w-[16px] h-4 px-1 rounded-full bg-viridian text-white text-[10px] font-bold flex items-center justify-center tabular">
                {cartCount}
              </span>
            )}
          </Link>
