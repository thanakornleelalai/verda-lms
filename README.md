...
- **กดหัวใจ ♡ บันทึกคอร์สที่ถูกใจ** (Wishlist) ไว้ลงทะเบียนภายหลัง
- **ตะกร้าสินค้า** — เก็บหลายคอร์สก่อนจ่ายเงิน (persist ข้ามรีโหลด)
- ซื้อคอร์สด้วยบัตรเครดิตหรือ PromptPay + โค้ดส่วนลด
- ดูวิดีโอบทเรียนพร้อมติดตามความคืบหน้า
- ทำแบบทดสอบพร้อมจับเวลา (กด A B C D จากคีย์บอร์ดได้)
- **รีวิวคอร์ส + ผู้สอน** (ให้คะแนน 2 แกน) และ **ถาม-ตอบ** ข้อสงสัยกับผู้สอน
- รับและดาวน์โหลดใบประกาศนียบัตรดิจิทัล
- แดชบอร์ดส่วนตัว — คอร์สที่เรียน, wishlist, certificate, ตั้งค่าโปรไฟล์
