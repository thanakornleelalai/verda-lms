...
> **หมายเหตุ:** ลบคอร์ส "Machine Learning Specialization" เดิม (ของคุณพิมพ์พร) ออก เหลือฉบับ Andrew Ng ฉบับเดียว · เปลี่ยนชื่อผู้สอน คุณพิมพ์พร → คุณพิมพ์พร วัฒนากร · "สิ่งที่คุณจะได้เรียนรู้" (Course.outcomes) แยกตามคอร์สแล้ว (ไม่ hardcode UX อีกต่อไป)
